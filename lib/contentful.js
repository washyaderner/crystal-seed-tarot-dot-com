...
const BLOG_DEFAULTS = {
  ...
  imagePadding: 'p-3 pb-1',  // Standard padding for image containers
  cardStyle: 'bg-gray-900/50 backdrop-blur-sm rounded-xl overflow-hidden', // Standard card styling
  imageStyle: 'rounded-lg overflow-hidden', // Standard image styling
  titleStyle: 'font-bold', // Standard title styling
