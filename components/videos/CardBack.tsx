...
import { CARD_BACK_URL, CARD_BACK_RADIUS, CARD_BACK_RATIO, chipGlowClass } from "@/lib/youtube-videos";
 ...
 * reading 1, 2 and 3 apart. The chips light up from dark (1) to the lit
 * crystal (3). Size it with a width class.
 */
